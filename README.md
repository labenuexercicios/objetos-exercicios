...
-  [ ] Crie uma nova branch: git checkout -b `<turma-nome-sobrenome-a011>`.
   <details>
...
-  [ ] Dê push nos commits: git push origin `<turma-nome-sobrenome-a011>`.
...
[Introdução a objetos em Javascript - Aprendendo desenvolvimento web | MDN](https://developer.mozilla.org/pt-BR/docs/Learn/JavaScript/Objects)
