...
pokemon2.tipo = "Água"
console.log ("copia com nome alterado", pokemon2)


// b) No objeto original, adicione mais uma propriedade, chamada `ataques`. Esta propriedade 
// deve guardar um **array** de objetos com a estrutura abaixo. Inicie a propriedade como um 
// array vazio, e crie o objeto abaixo utilizando `**push()**`
// ```text
// nome: Investida;
// dano: 40;
// tipo: Normal;
...
//  **espalhamento** da propriedade criada para o objeto original;
